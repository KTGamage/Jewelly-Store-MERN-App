      ...
      <div className="max-w-6xl mx-auto">
        ...
        <div className="grid grid-cols-1 xl:grid-cols-3 gap-8">
          ...
          <div className="xl:col-span-2 space-y-6">
            <div className="bg-white/80 backdrop-blur-sm rounded-2xl shadow-xl border border-white/50 overflow-hidden">
              <div className="bg-gradient-to-r from-purple-600 to-blue-600 text-white p-6">
                <h3 className="text-xl font-bold">Your Items ({cart.items.length})</h3>
              </div>
              
              <div className="divide-y divide-gray-200">
                {cart.items.map(item => (
                  <div key={item.product} className="p-6 hover:bg-gray-50/50 transition-colors duration-300">
                    <div className="flex items-center space-x-6">
                      <div className="relative">
                        <img 
                          src={item.image} 
                      ...
                      <div className="flex-1 min-w-0">
                        <div className="flex justify-between items-start mb-2">
                          <div>
                            <h3 className="font-bold text-lg text-gray-900 truncate">{item.name}</h3>
                            <p className="text-purple-600 text-sm font-medium">${item.price}</p>
                          </div>
                          <button
            ...
            <div className="bg-white/80 backdrop-blur-sm rounded-2xl shadow-2xl border border-white/50 sticky top-4">
              ...
              <div className="p-6 space-y-4">
                ...
                <button 
                  ...
                  disabled={loading}
                  className="w-full bg-gradient-to-r from-purple-600 to-blue-600 text-white py-4 rounded-xl hover:shadow-2xl transition-all duration-300 transform hover:scale-105 font-bold text-lg mb-4 disabled:opacity-50"
                >
                  {loading ? 'Processing...' : 'Place Order (Free)'}
                </button>
